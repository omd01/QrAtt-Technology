...
const Verify = ({navigation}) => {
  ...
  const Color = colors[theme.mode]
    ...
    useEffect(() => {
        user.verified &&  navigation.navigate("home")
    }, [loading])
    ...
    >
      ...
      <View style={{height:Size.Full}}>
        ...
        >
          ...
          >
            Enter the OTP sent to your email address also check your spam folder
          </Text>
  ...
  {error ? (
          ...
          <ButtonD value={"Verify"} loading={loading} onPress={handleSubmit} disabled={isValid?false:true} style={{width:150,borderRadius:50,alignSelf:'center',marginVertical:5}} />
        </View>
